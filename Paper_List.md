...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Spatio-spectral feature representation for motor imagery classification using convolutional neural network | J.-S. Bang et al. | Backpropagation Methods | LRP | Attribution | / | |
| 2 | A gradient-based approach for explaining multimodal deep learning classifiiers | C. A Ellis et al. | Backpropagation Methods | LRP | Attribution | / | |
